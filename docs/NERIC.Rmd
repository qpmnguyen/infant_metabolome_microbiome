...
```{r, fig.cap="**Figure 1.** RMSE and R-squared scores averaged across folds then across all metabolites for each model"}
knitr::include_graphics("model_specific_comparision.png")
```
The graph above shows that the results for random forest models are 
